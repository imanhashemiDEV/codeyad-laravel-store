<div class="grid grid-cols-1 gap-6 p-4">
        ...
        <div class="mb-5">
            ...
            <form  class="space-y-5">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
                    ...
                    <div>
                        <label for="mobile">عکس دسته بندی</label>
    ...
    <div class="panel p-5">
        <a href="{{route('admin.trashed_categories.list')}}" type="button" class="btn btn-danger mb-4 w-[300px]">
                    ...
                    @foreach($this->categories as $index => $category)
                        <tr>
                            ...
                            <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                ...
                                <button wire:click="$dispatch('delete-category', { category_id : {{$category->id}} })" type="button" x-tooltip="حذف">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
