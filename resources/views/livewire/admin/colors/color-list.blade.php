<div class="grid grid-cols-1 gap-6 p-4">
    <div class="panel p-5">
        ...
        <div class="mb-5">
            <h1 class="my-4 text-xl font-semibold">ایجاد رنگ</h1>
                ...
                <table>
                    ...
                    @foreach($this->colors as $index => $color)
                        <tr>
                            ...
                            <td class="whitespace-nowrap"><span class="badge text-black" style="background-color: {{$color->code}}">{{$color->name}}</span></td>
                            <td class="whitespace-nowrap">{{ \Hekmatinasser\Verta\Verta::instance($color->created_at)->formatJalaliDate()}}</td>
                            <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                ...
                                <button wire:click="$dispatch('delete-color', { color_id : {{$color->id}} })" type="button" x-tooltip="حذف">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
