<div class="grid grid-cols-1 gap-6 p-4">
    <div class="panel p-5">
        ...
        <div class="mb-5">
            <h1 class="my-4 text-xl font-semibold">ایجاد گارانتی</h1>
                ...
                <table>
                    ...
                    @foreach($this->guaranties as $index => $guaranty)
                        <tr>
                            ...
                            <td class="whitespace-nowrap">{{ \Hekmatinasser\Verta\Verta::instance($guaranty->created_at)->formatJalaliDate()}}</td>
                            <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                ...
                                <button wire:click="$dispatch('delete-guaranty', { guaranty_id : {{$guaranty->id}} })" type="button" x-tooltip="حذف">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
