<div class="grid grid-cols-1 gap-6 p-4">
    <div class="panel p-5">
        ...
        <div class="mb-5">
            <h1 class="my-4 text-xl font-semibold">ایجاد برند</h1>
            <form  class="space-y-5">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
                    ...
                    <div>
                        <label for="mobile">عکس برند</label>
                ...
                <table>
                    ...
                    @foreach($this->brands as $index => $brand)
                        <tr>
                            ...
                            <td class="whitespace-nowrap">{{ \Hekmatinasser\Verta\Verta::instance($brand->created_at)->formatJalaliDate()}}</td>
                            <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                ...
                                <button wire:click="$dispatch('delete-brand', { brand_id : {{$brand->id}} })" type="button" x-tooltip="حذف">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
